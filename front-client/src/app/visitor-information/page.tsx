  ...
  return (
    <section className="px-4 py-10 md:px-8 md:py-16 bg-neutral-700">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Section Accès parking - INFOS À GAUCHE, MAP À DROITE */}
        <div className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-neutral-50 mb-6 border-b-2 border-primary-purple-300 pb-3 inline-block">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="space-y-5">
              {/* Adresse */}
              <div className="bg-neutral-700 border border-primary-purple-300 rounded-lg p-5 hover:border-secondary-300 transition-colors duration-300" style={{backgroundColor: '#201041'}}>
