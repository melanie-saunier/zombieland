...
export default function cgvPage() {
  ...
  return(
    <div className="bg-radial from-[#961990] to-[#000000] p-12">
      ...
      <h2 className="text-shadow-none! tracking-normal! pl-6 pt-6 pr-6 pb-2">2. Réservation</h2>
      ...
      <h2 className="text-shadow-none! tracking-normal! pl-6 pt-6 pr-6 pb-2">3. Confirmation et validité</h2>
      <ul className="list-inside list-disc">
      ...
      <h2 className="text-shadow-none! tracking-normal! pl-6 pt-6 pr-6 pb-2">4. Paiement</h2>
      <ul className="list-inside list-disc">
      ...
      <h2 className="text-shadow-none! tracking-normal! pl-6 pt-6 pr-6 pb-2">5. Annulation/Modification</h2>
      <ul className="list-inside list-disc">
      ...
      <h2 className="text-shadow-none! tracking-normal! pl-6 pt-6 pr-6 pb-2">6. Responsabilité</h2>
      <ul className="list-inside list-disc">
      ...
      <h2 className="text-shadow-none! tracking-normal! pl-6 pt-6 pr-6 pb-2">7. Données personnelles</h2>
      <p>Les informations collectées lors de la réservation sont traitées conformément à notre Politique de Confidentialité.</p>

      <h2 className="text-shadow-none! tracking-normal! pl-6 pt-6 pr-6 pb-2">8. Droit applicable</h2>
      <p>Les présentes CGV sont régies par le droit français. Tout litige sera soumis aux tribunaux compétents.</p>

      <p><span className="font-semibold">Contact</span> Pour toute question : contact@zombieland.fr</p>
      <div className="flex justify-center pt-4"><Skull className=" stroke-[#4ea11e]" /></div>
    </div>
