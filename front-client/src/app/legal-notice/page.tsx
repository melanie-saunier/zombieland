...
export default function legalNoticePage() {
  ...
  return (
    <div className="bg-radial from-[#961990] to-[#000000] p-8">
      <h1 className="flex items-center text-shadow-none! tracking-normal! justify-center p-6">MENTION LÉGALES</h1>
      ...
      <h2 className="text-shadow-none! tracking-normal! p-6">Edition du site</h2>
      ...
      <h2 className="text-shadow-none! tracking-normal! p-6">Hébergement</h2>
      ...
      <h2 className="text-shadow-none! tracking-normal! p-6">Directeur de publication</h2>
      <p>Le Directeur de la publication du Site est Emilie Dupont.</p>

      <h2 className="text-shadow-none! tracking-normal! p-6">Nous contacter</h2>
      <p>Par téléphone : +33189716530
        Par email : contact@Oclock.io
        Par courrier : 10 Bd de Parc, 77700 Coupvray</p>

      <h2 className="text-shadow-none! tracking-normal! p-6">Données personnelles</h2>
