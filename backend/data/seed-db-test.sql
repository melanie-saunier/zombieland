...
UNION ALL
SELECT CURRENT_DATE + INTERVAL '7 days', 2, true, u.id FROM "user" u WHERE u.email = 'alfred.lechien@gmail.com'
UNION ALL
SELECT CURRENT_DATE + INTERVAL '10 days', 3, false, u.id FROM "user" u WHERE u.email = 'alfred.lechien@gmail.com'
UNION ALL
...
UNION ALL
SELECT CURRENT_DATE - INTERVAL '5 days', 1, true, u.id FROM "user" u WHERE u.email = 'bunny.lelapin@gmail.com';

-- BOOKING_PRICE
INSERT INTO booking_price (applied_price, booking_id, price_id)
SELECT 30.00, b.id, p.id
FROM booking b
...
JOIN "user" u ON b.user_id = u.id
JOIN price p ON p.label = 'Tarif unique'
WHERE u.email = 'alfred.lechien@gmail.com';
...
JOIN "user" u ON b.user_id = u.id
JOIN price p ON p.label = 'Tarif unique'
WHERE u.email = 'bunny.lelapin@gmail.com';
